...
use iron_core_cluster::{
    IronCat, IronClusterEntityValue, IronClusterManager, IronClusterWriteRequest,
};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    cluster_handler
        .write_cluster_data(IronClusterWriteRequest::Insert(
            IronClusterEntityValue::Cat(IronCat {
        ...
        .await?;
    cluster_handler
        .write_cluster_data(IronClusterWriteRequest::Delete(
            IronClusterEntityValue::Cat(IronCat {
                id: cluster_handler.current_node_id(),
                name: cluster_handler.current_node_addr(),
